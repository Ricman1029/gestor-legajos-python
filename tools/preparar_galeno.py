...
from tests.utilidades import llenar_campo
...
def generar_formulario_galeno():
    ...
    llenar_campo(page, "ficha, etc.", "empleado_legajo", x=50, y=3)
    llenar_campo(page, "Lugar y Fecha", "documento_lugar_y_fecha", x=-50, y=14)
    # # Legajo
    # widget = pymupdf.Widget()
