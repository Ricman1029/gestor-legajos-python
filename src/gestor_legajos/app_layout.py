import flet
from gestor_legajos.views.routes import router
from gestor_legajos.controles.sidebar import Sidebar
from gestor_legajos.state import State
from gestor_legajos.utils.persistencia import (obtener_lista_empresas,
                                                        leer_convenios,
                                                        leer_sindicatos,
                                                        leer_obras_sociales,
                                                        leer_opciones_pdfs)
