import flet
from src.entidades.empresa import Empresa, Domicilio
from src.controles.mi_textfield import MiTextField
from src.state import State, global_state
from src.utils.persistencia import leer_convenios, leer_sindicatos
